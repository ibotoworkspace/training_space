<h3>Upload Quiz/Questions from File</h3>
<hr>
                    <form method="POST" action="{{ route('uploadQuiz') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="title" value="NewQuiz">
                        <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <!-- Quiz File Upload -->
                                <div class="form-group">
                                    <label for="quiz_file">Upload Quiz File</label>
                                    <input type="file" name="quiz_file" id="quiz_file" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="questions_file" id="questions_file" class="form-control" required>
                                </div>
                            </div>
                        </div>
