...
<form action="{{ route('save-update') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" name="material_title" id="material_title" class="form-control" value="{{$course->material_title}}">
    </div>

    <div class="form-group">
        <label for="wyswyg">Description:</label>
        <textarea name="description" id="wyswyg" class="form-control">{{$course->description}}</textarea>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="number" name="ordering" id="ordering" class="form-control" value="{{$course->ordering}}">
        </div>

        <div class="form-group col-md-3">
            <label for="material_type">Material Type:</label>
            <select name="material_type" id="material_type" class="form-control">
                <option value="{{$course->material_type}}" selected>{{$course->material_type}}</option>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            <input type="date" name="start_date" id="start_date" value="{{$course->start_date}}" class="form-control">
        </div>

        <div class="form-group col-md-3">
            <label for="end_date">End Date:</label>
            <input type="date" name="end_date" id="end_date" class="form-control" value="{{$course->start_date}}">
        </div>
